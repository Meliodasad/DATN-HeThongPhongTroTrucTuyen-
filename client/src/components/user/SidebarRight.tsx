    ...
    <div className="sidebar-container">
      ...
      <div className="sidebar-section">
        ...
        <div className="area-area">
          <div>
            <p onClick={() => setSearchRoom((pre: any) => ({ ...pre, maxArea: 20 }))}><span>›</span> <a href="#">Dưới 20 m²</a></p>
          ...
          <div>
            ...
            <p onClick={() => setSearchRoom((pre: any) => ({ ...pre, minArea: 90 }))}><span>›</span> <a href="#">Trên 90m²</a></p>
          </div>
        </div>
      </div>
